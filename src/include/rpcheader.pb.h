...
class RpcHeader :
 ...
 public:
  ...
  // int32 argsSize = 1;
  void clear_argssize();
  ::PROTOBUF_NAMESPACE_ID::int32 argssize() const;
  void set_argssize(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_argssize() const;
  void _internal_set_argssize(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 argssize_;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 RpcHeader::_internal_argssize() const {
  return argssize_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 RpcHeader::argssize() const {
  // @@protoc_insertion_point(field_get:header.RpcHeader.argsSize)
  return _internal_argssize();
}
inline void RpcHeader::_internal_set_argssize(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  argssize_ = value;
}
inline void RpcHeader::set_argssize(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_argssize(value);
  // @@protoc_insertion_point(field_set:header.RpcHeader.argsSize)
}
...
inline const std::string& RpcHeader::servicename() const {
  // @@protoc_insertion_point(field_get:header.RpcHeader.serviceName)
  return _internal_servicename();
}
inline void RpcHeader::set_servicename(const std::string& value) {
  _internal_set_servicename(value);
  // @@protoc_insertion_point(field_set:header.RpcHeader.serviceName)
}
inline std::string* RpcHeader::mutable_servicename() {
  // @@protoc_insertion_point(field_mutable:header.RpcHeader.serviceName)
...
inline void RpcHeader::set_servicename(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:header.RpcHeader.serviceName)
}
inline void RpcHeader::set_servicename(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:header.RpcHeader.serviceName)
}
inline void RpcHeader::set_servicename(const char* value, size_t size) {
  
  servicename_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:header.RpcHeader.serviceName)
}
...
inline std::string* RpcHeader::release_servicename() {
  // @@protoc_insertion_point(field_release:header.RpcHeader.serviceName)
...
inline void RpcHeader::set_allocated_servicename(std::string* servicename) {
  ...
  // @@protoc_insertion_point(field_set_allocated:header.RpcHeader.serviceName)
}
...
inline const std::string& RpcHeader::methodname() const {
  // @@protoc_insertion_point(field_get:header.RpcHeader.methodName)
  return _internal_methodname();
}
inline void RpcHeader::set_methodname(const std::string& value) {
  _internal_set_methodname(value);
  // @@protoc_insertion_point(field_set:header.RpcHeader.methodName)
}
inline std::string* RpcHeader::mutable_methodname() {
  // @@protoc_insertion_point(field_mutable:header.RpcHeader.methodName)
...
inline void RpcHeader::set_methodname(std::string&& value) {
  ...
  methodname_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:header.RpcHeader.methodName)
}
inline void RpcHeader::set_methodname(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:header.RpcHeader.methodName)
}
inline void RpcHeader::set_methodname(const char* value, size_t size) {
  ...
  methodname_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:header.RpcHeader.methodName)
}
...
inline std::string* RpcHeader::release_methodname() {
  // @@protoc_insertion_point(field_release:header.RpcHeader.methodName)
...
inline void RpcHeader::set_allocated_methodname(std::string* methodname) {
  ...
  // @@protoc_insertion_point(field_set_allocated:header.RpcHeader.methodName)
}
